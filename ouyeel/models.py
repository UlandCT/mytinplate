...
class Ouyeel(models.Model):
    ...
    batchId = models.CharField(max_length=20, verbose_name="批次", null=True, blank=True)
    ...
    coatingType = models.CharField(max_length=20, verbose_name="包装类型", null=True, blank=True)
    ...
    midTagPicUrl = models.CharField(max_length=50, verbose_name="标签图片地址", null=True, blank=True)
    ...
    qualityGradeName = models.CharField(max_length=50, verbose_name="质量等级名称", null=True, blank=True)
    ...
    shopSign = models.CharField(max_length=20, verbose_name="产品材质", null=True, blank=True)
    ...
    specialComments = models.CharField(max_length=20, verbose_name="特别说明", null=True, blank=True)
    ...
    techStandard = models.CharField(max_length=20, verbose_name="技术标准", null=True, blank=True)
